    ...
    items: {
      claudocs: {
        ...
        why: [
          ...
          "and workspace members can fill it in and send it back to you.",
          "It's a workspace SaaS that handles review and approval too.",
    ...
    items: {
      langport: {
        ...
        why: [
          ...
          "MyRealTrip, one place to see meetups scattered all over, would be great, so I spent about a week building it.",
        ],
        tags: ["Private repo"],
      },
    },
