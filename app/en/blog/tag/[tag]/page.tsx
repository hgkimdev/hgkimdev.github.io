...
export async function generateStaticParams() {
  const tags = getTagCounts(getAllPosts("en"));
...
function findTagLabel(slug: string): string | undefined {
  return getTagCounts(getAllPosts("en")).find((t) => t.key === slug)?.label;
}
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: label ? blogAlternates(`/blog/tag/${slug}`, "en") : undefined,
  };
}
